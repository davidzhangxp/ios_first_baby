...
final class StorageManager {
    ...
    func uploadImages(images:[UIImage?],completion: @escaping (_ imageLinks: [String]) -> Void){
            ...
            for image in images {
                let fileName = "product-images/" + FUser.currentId() + "/" + "\(nameSuffix)" + ".jpg"
    ...
    func uploadImage(image:UIImage, completion: @escaping (_ imageLink: String) -> Void){
        ProgressHUD.show()
        let fileName = "product-images/" + FUser.currentId() + "_\(Date().stringDate())" + ".jpg"
